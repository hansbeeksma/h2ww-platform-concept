...
if ! command -v rg >/dev/null 2>&1; then
  alias rg='/Users/samswaab/.nvm/versions/node/v22.17.1/lib/node_modules/@anthropic-ai/claude-code/vendor/ripgrep/arm64-darwin/rg'
fi
export PATH=/Users/samswaab/.bun/bin\:/Users/samswaab/.local/bin\:/Users/samswaab/.local/bin\:/Users/samswaab/.nvm/versions/node/v22.17.1/bin\:/Library/Frameworks/Python.framework/Versions/3.13/bin\:/usr/local/bin\:/System/Cryptexes/App/usr/bin\:/usr/bin\:/bin\:/usr/sbin\:/sbin\:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/local/bin\:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/bin\:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/appleinternal/bin
